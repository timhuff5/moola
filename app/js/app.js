/*!
 * 
 * Bootstrap + AngularJS Material
 * For HP IT Template
 * Compiled by: Tim Huff
 * 28 November, 2015
 * Version: 1.2.0
 */
...
(function() {
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper){
        ...
        $stateProvider
          ...
          .state('app.welcome', {
              url: '/welcome',
              title: 'Welcome to Moola',
              templateUrl: helper.basepath('welcome.html'),
              resolve: helper.resolveFor('angular-carousel',
'infinite-scroll', 'icons', 'moment', 'taginput', 'inputmask', 'localytics.directives', 'ui.bootstrap-slider', 'ngWig', 'filestyle', 'textAngular', 'ui.select', 'classyloader', 'ui.knob', 'easypiechart', 'datatables')
          })
